-- ============================================
-- 07_restore_deals_policies.sql
-- Restores RLS policies to use correct 'org_id' column for deals table.
-- Fixes breakdown caused by 06_fix_rls_policies.sql
-- ============================================

-- 1. DEALS POLICIES (Use org_id)
...
-- 2. GL TRANSACTIONS POLICIES (Use deals.org_id)
...
-- These rely on deals.org_id too!
