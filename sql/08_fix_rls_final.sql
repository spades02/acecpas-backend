-- ============================================
-- 08_fix_rls_final.sql
-- Restores RLS policies using correct 'organization_id' column for deals table.
-- Fixes breakdown caused by schema mismatch (org_id vs organization_id).
-- ============================================

-- 1. DEALS POLICIES (Use organization_id)
...
-- 2. GL TRANSACTIONS POLICIES (Use deals.organization_id)
...
DROP POLICY IF EXISTS "Users can delete files in their deals" ON uploaded_files;
CREATE POLICY "Users can delete files in their deals"
